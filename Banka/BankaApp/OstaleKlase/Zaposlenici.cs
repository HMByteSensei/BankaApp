...
public class Zaposlenici : Osoba
{
    ...
    // override metodu ToString za zaposlenike
    public override string ToString()
    {
        return $"ID: {ID, -16}| Ime: {base.Ime, -14}| Prezime: {base.Prezime, -10}| Adresa: {base.Adresa, -11}| " +
            $"BrojTel: {base.BrojTel, -10}| Email: {base.Email, -12}| JMBG: {base.LicnaKarta, -13}| kIme: {base.KorisnickoIme, -13}| Pozicija: {pozicija, -10}";
    }
